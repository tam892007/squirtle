...
angular.module('localization', ['LocalStorageModule'])
    ...
    .provider('localize', function localizeProvider() {
        ...
        this.$get = [
            '$http', '$rootScope', '$window', '$filter', 'localStorageService', function ($http, $rootScope, $window, $filter, localStorageService) {
                ...
                var localize = {
                    ...
                    setLanguage: function (value) {
                        ...
                        localStorageService.cookie.set('language', localize.language); //persist in local storage
                    ...
                    // check languague is current language
                    isCurrentLanguage: function (value) {
                        var language = this.fallbackLanguage(value);
                    ...
                    buildUrl: function (baseUrl) {
                        if (!localize.language) {
                            var value = localStorageService.cookie.get('language'); //get from local storage;
                            if (value) {
