'use strict';
mainApp.controller('transactionHistoryController', ['$scope', 'userService', 'transactionService', '$q', 'Notification', '$state', function ($scope, userService, transactionService, $q, Notification, $state) {
    ...
    $scope.getCurrentUserPinTransactionHistory = function () {
        return transactionService.getCurrentUserHistory().$promise;
    }
