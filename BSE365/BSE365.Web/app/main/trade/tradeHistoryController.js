'use strict';
mainApp.controller('tradeHistoryController', ['$scope', 'userService', 'transactionService', '$q', 'Notification', '$state', function ($scope, userService, transactionService, $q, Notification, $state) {
