'use strict';
mainApp.controller('tradeWaitingGiversController', ['$scope', 'userService', 'tradeService', '$q', 'Notification', '$state', function ($scope, userService, tradeService, $q, Notification, $state) {
