...
namespace BSE365.Base.DataContext
{
    public class DataContext : DbContext, IDataContextAsync
    {
        ...
        private void SyncObjectsStatePreCommit()
        {
            ...
            {
                var changeData = ChangeTracker.Entries().Where(x => x.State == EntityState.Modified).ToList();
                OnBeforeUpdate(ChangeTracker, changeData);
            }
        }
        ...
        protected delegate void DBeforeUpdate(DbChangeTracker changeTracker, List<DbEntityEntry> changeData);

        protected event DBeforeUpdate OnBeforeUpdate;
    }
}